...
class EnsemblePursuitTFIDF():
    ...
    def fit_one_ensemble(self,X):
        ...
        top_neurons=self.sorting_for_seed(self.tfidf_mat)
        n=0
    ...
    def sorting_for_seed(self,tfidf_scores):
        '''
        ...
        sorted_similarities,_=tfidf_scores.sort(dim=1)
    ...
    def fit_transform(self,X):
        ...
        tfidf_mat = vectorizer.fit_transform(X.cpu().numpy().T) 
        self.tfidf_mat=torch.cuda.FloatTensor(tfidf_mat.todense().T)
